        ...
        <>
          ...
          <div className="w-32 md:w-40 h-10 md:h-12 flex items-center justify-center overflow-hidden">
            ...
            />
                            ...
                            <p className="text-white font-medium">Premium rail journeys across the states</p>
                        </div>
                        ...
                        {filteredRoutes.map((route) => (
                            ...
                            >
                                ...
                                <div className="w-full md:w-48 flex flex-row md:flex-col items-center justify-between md:justify-center border-t md:border-t-0 md:border-l-2 border-slate-50 pt-4 md:pt-0 md:pl-8">
                                    ...
                                    <button onClick={() => window.gtag_report_conversion('tel:+18001234567')} className="bg-[#2273CB] cursor-pointer hover:bg-[#D71926] hover:text-white text-white px-8 py-3 rounded-xl font-black text-sm uppercase transition-all duration-300 shadow-md transform hover:scale-101">
                                            Book Now
                                    </button>
